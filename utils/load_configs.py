...
def get_link_prediction_args(is_evaluation: bool = False):
    ...
    parser.add_argument('--init_weights', type = str, choices = ['degree', 'log-degree', 'time-exp', 'time-linear', 'time-fourier', 'time-mlp', 'time-mlp2', 'time-3unite', 'normal-dyg', 'time-quad', 'time-cubic', 'time-context'])
